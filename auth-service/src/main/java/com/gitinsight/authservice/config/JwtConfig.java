 ...
 * module for auth-service, which both mints tokens at login/refresh and
 * validates them. Kept separate from {@link SecurityConfig} so the filter bean
 * can be injected there without a circular reference.
 *
...
public class JwtConfig {
    ...
    public JwtUtil jwtUtil(
        ...
        return new JwtUtil(secret, expirationMs, refreshExpirationMs, minSecretBytes);
    }
