...
/**
 * Env-driven CORS for github-service. Only needed when the frontend is hosted on
 ...
 * HttpOnly session cookies are sent on cross-origin XHR; the Authorization
 * header remains supported for API clients.
 */
@Configuration
